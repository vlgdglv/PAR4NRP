...
def main(args):
    ...
    # head.* weights on load. (Training toggles these via the RowARArgs
    # defaults; inference must mirror the ckpt's actual architecture.)
    ...
    model = RowAR_models[args.model](
        ...
        use_glat=False,  # GLAT is a training-time flag; inference never reveals
